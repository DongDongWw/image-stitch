...
void brief_gao(const cv::Mat &img, vector<cv::KeyPoint> &keypoints, vector<KeyPoint>& nice_kp_vec,vector<Desctype> &descriptors) {
    ...
    for (auto &kp: keypoints) {
        if (kp.pt.x < half_boundary || kp.pt.y < half_boundary ||
            ...
            nice_kp_vec.push_back(kp);
    }
    for(auto &kp: nice_kp_vec) {
        float m01 = 0, m10 = 0;
